...
class App extends React.Component
{
    ...
    componentDidMount()
    {
        ...
        {
            if (document.getElementsByClassName('screen-menu')[0].classList.contains('screen-menu-hide'))//this rotating facility will only be available when the side bar is shown to the user.
            {
    ...
    selectButtonClicked = () =>
    {
        if(this.state.currently_playing&&!document.getElementsByClassName('screen-menu')[0].classList.contains('screen-menu-hide'))//if i am currently on the play music screen and the side bar is hidden, in that case if i click on the select button, ideally nothing should happen.
        {
            return;
        }
        ...
        if (!document.getElementsByClassName('screen-menu')[0].classList.contains('screen-menu-hide'))//side menu is not visible
        {
            if (this.state.options.length === 3)//I must be on the music section
            {
                if (this.state.showPage === 0)//I am on Songs page
                {
    ...
    leftButtonClicked = () =>
    {
        ...
        if (this.state.currently_playing)//if i am on the play music screen
        {
            if (!document.getElementsByClassName('screen-menu')[0].classList.contains('screen-menu-hide'))//if the menu is not present on the screen
            {
